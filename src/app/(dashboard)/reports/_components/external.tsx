...
const overviewsDates = overviews.map((item:any) => toDate(item.date).getTime())
const maxDate = toDate(Math.max(...overviewsDates))

export default function OverviewExternal() {
      ...
      <section aria-labelledby="usage-overview">
        ...
        <div className="sticky top-16 z-20 flex items-center justify-between border-b border-gray-200 bg-white pb-4 pt-4 sm:pt-6 lg:top-0 lg:mx-0 lg:px-0 lg:pt-8 dark:border-gray-800 dark:bg-gray-950">
          <Filterbar
            ...
            onDatesChange={(dates:any) => setSelectedDates(dates)}
            selectedPeriod={selectedPeriod}
            onPeriodChange={(period:any) => setSelectedPeriod(period)}
        ...
        >
          {categories
            .filter((category:any) => selectedCategories.includes(category.title))
